...
$confor="SELECT id_form,tipo_iden,numero_iden_per,nombre,edad,direccion_per,telefono_per,nombre_eps,fecha_aten,id_profesional,identificacion_profe,nombre_profe FROM vw_formula_encabezado WHERE id_aten='$_POST[id_aten]'";
//echo $confor;
...
<body>
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-12">Diagnóstico: <?php echo $dx_cod;?></div>                
            </div>
        </div>
