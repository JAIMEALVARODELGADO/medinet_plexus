...
$sql="SELECT id_factura, SUBSTR(fecha_fac,1,10), numero_iden_per, nombre_pac, numero_conv, nombre_eps,valorneto_fac FROM vw_factura WHERE esta_fac='A' ORDER BY fecha_fac";
//echo "<br>".$sql;
