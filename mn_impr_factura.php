...
$confac="SELECT id_factura,numero_fac, tipoiden_per, numero_iden_per, nombre_pac, direccion_per, telefono_per, numero_conv, nombre_eps, SUBSTR(fecha_fac,1,10), valortot_fac, copago_fac, descuento_fac, valorneto_fac, esta_fac, identif_operador, nombre_operador,fechacierre_fac,prefijo_fac
