...
$sql="SELECT id_aten, fecha_aten, numero_iden_per, nombre,codigo_cups,descripcion_cups, nombre_eps, nombre_profesional, id_persona,id_con,tipoaten FROM vw_atencion_fac WHERE facturado<>'S' AND ".$_SESSION['gcondicion']." ORDER BY fecha_aten";
echo "<br>".$sql;
